...
Files:
  ...
  etest.c   - main loop for Section A testing
  etest.h   - Section A header file (nothing there)
  employee.c - c file holding functions for employees
  employee.h - header file for holding employer structs and prototypes
  part3.c - main loop for Part C of section A
  part3.h - header file for Section A code, just prototypes
  part5.c - Part 5 code main loop
  part5.h - Part 5 header file
  part6.c - Part 6 main loop
  part6.h - header for Part 6 code
  part7.c - Part 7 main loop code
  part7.h - Header for Part 7
